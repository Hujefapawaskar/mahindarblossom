...
const SpecsLocationSection = () => {
  return (
    <section className="px-4 sm:px-6 bg-white mt-8 sm:mt-12 lg:-mt-45 mb-16">
          ...
          {specs.map((item, index) => (
            ...
            >
              ...
              <div className="p-5 space-y-3">
                <h3 className="font-serif uppercase text-center text-gray-700 text-xs font-bold">
                  {item.title}
                </h3>
      ...
      <div className="max-w-7xl mx-auto mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="gsap-fade-up space-y-4">
          <h2 className="text-3xl sm:text-4xl font-serif font-bold text-gray-700">
        ...
        {/* Map */}
        <div className="gsap-image w-full rounded-2xl overflow-hidden shadow-xl">
          <img
            src={locationMapImg}
            alt="Location Map"
            className="w-full h-56 sm:h-72 md:h-85 lg:h-95 object-cover p-10"
            loading="lazy"
          />
        </div>
      </div>
